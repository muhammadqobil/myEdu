    ...
    <div class="row q-col-gutter-sm">
          ...
          <template v-slot:body-cell-branches="props">
            <q-td :props="props">
              <div class="row">
                <div class="col name-column">
                  <span> {{$t('captions.l_name')}} : </span>
                  <span v-if="props.row.branches"  class="text-bold">
      ...
      <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <div class="full-height bg-white">
          <rooms-mini-card v-if="selectedRows && selectedRows[0]" :roomsId="selectedRows[0].id"/>
          <template v-else>
...
import RoomsMiniCard from "components/myEdu/RoomsMiniCard";

export default {
  name: "Rooms",
  components: {RoomsMiniCard, StandartInputDialog},
